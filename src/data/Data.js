...
export const HomePageFaqData = {
    ...
    questions: [
        ...
        `,
            answer: 'You can request a detailed estimate for car or home insurance online. For other products, submit an online form, call 866-COUNTRY (866-268-6879) or contact your local rep to get a quote.',
        },
        {
            question: 'Who’s there to support me?',
            answer: 'Your local rep is there to help with anything you need, along with our client support center, which can be reached at 866-COUNTRY (866-268-6879). You can also pay your bill, start a claim, print an insurance card and more through your online account or our mobile app.',
        },
        {
...
export const CarInsuranceContentModuleData = {
    content1: `<p>Car insurance is a contract between you and an insurance company in which you pay a premium and the insurance company agrees to pay for certain types of financial losses in the event of an accident or theft.<br />The most common types of car insurance are liability, collision, and comprehensive coverage. Liability coverage is required by law and covers damages or injuries that you may cause to another person or their property while operating your vehicle.</p>`,
    content2:
