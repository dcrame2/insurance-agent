  ...
  questions: [
    {
      question: `How do I get a quote?
        `,
      answer:
        'You can request a detailed estimate for car, home, life and business insurance via my contact form or contact me my direct phone number (847) 903-9641 or via email mike.moulis@countryfinancial.com to get a quote.',
    },
    {
      question: 'Who’s there to support me?',
      answer:
        'My team and I are there to help with anything you need, along with our client support center, which can be reached at 866-268-6879. You can also pay your bill, start a claim, print an insurance card and more through your online account or our mobile app.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'When you file a claim, the unknown can be the hardest part. My team and I will work hard to make the process as easy as possible. Once you place a claim online or via the mobile app, a claim rep will reach out to explain your options, answer any questions and review your policy. Your claim rep is your main point of contact throughout the process, but your I am always there for support.',
    },
  ],
};
...
export const FooterData = {
  ...
  information: {
    ...
    links: [
      {
        href: 'mailto:mike.moulis@countryfinancial.com',
        text: 'mike.moulis@countryfinancial.com',
      },
      {
        href: 'tel:8479039641',
        text: '(847) 903-9641',
  ...
  questions: [
    {
      question: `What does a home insurance policy typically cover?
        `,
      answer:
        'A typical home insurance policy covers damages to your home and personal property due to events like fire, theft, and natural disasters. It also provides liability coverage if someone is injured on your property.',
    },
    {
      question: 'How can I determine the right amount of coverage for my home?',
      answer:
        'To determine the right amount of coverage for your home, consider the cost to rebuild your home, including materials and labor, and the value of your personal belongings. You can also get a professional home appraisal.',
    },
    {
    ...
    {
      question: 'How does my credit score affect my home insurance premium?',
      answer:
        'Your credit score can impact your home insurance premium because insurance companies often use it as an indicator of your overall financial responsibility and stability. A higher credit score may result in a lower premium.',
    },
    {
      question:
        'Can I add coverage for natural disasters like earthquakes or floods?',
      answer:
        "Yes, coverage for natural disasters like earthquakes or floods is usually not included in a standard home insurance policy and must be purchased as additional coverage. It's important to understand the risks specific to your area and to make sure you have the coverage you need.",
    },
  ],
};
...
export const CarInsuranceFaqData = {
  ...
  questions: [
    ...
    },
    {
      ...
      answer:
        'Car insurance claims are a process for seeking reimbursement for damages or losses sustained in a car accident. To make a claim, you typically need to provide proof of insurance, details of the accident, and documentation of damages and expenses. My team and I will help you through the entire process.',
    },
  ],
};
  ...
  questions: [
    {
      ...
      answer:
        "The types of insurance that a business may need can vary depending on the industry and specific risks of the business. Some common types of business insurance include general liability insurance, property insurance, worker's compensation insurance, professional liability insurance, and business interruption insurance.",
    },
    {
      question: 'How much does business insurance cost?',
      answer:
        'The cost of business insurance can also vary depending on the specific coverage and risks of the business. Factors that can affect the cost of business insurance include the industry, location, size of the business, and the amount of coverage needed.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Many insurance companies offer customizable business insurance policies that can be tailored to the specific needs of the business. Business owners can often add or remove coverage, adjust limits, and select endorsements to meet their specific needs.',
    },
  ],
};
